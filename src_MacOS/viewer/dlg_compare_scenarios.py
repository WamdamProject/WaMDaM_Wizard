...
class dlg_compare_scenarios( WaMDaMWizard.dlg_compare_scenarios ):
	...
	def btn_compare_scenariosOnButtonClick( self, event ):
		...
		changeInMetadataValueList = self.compareScenarios.GetChangeInMetadataValues_Attributes(selectedDataset, selectedMasterNetworkName,selectedScenarioName1, selectedScenarioName2)
		...
		try:
			if self.path.split('.')[-1] == 'xls':
				...
				try:
					...
					changeInMetadataValuesTopologySheet = workbook.get_sheet(2)
				except:
					message = msg_somethigWrong(None, msg="Please select a valid Excel File")
					message.ShowModal()
					return
				...
				for row_id, row in enumerate(changeInMetadataValueList):
					for col_id, cell in enumerate(row):
						changeInMetadataValuesTopologySheet.write(row_id + 3, col_id + 0, cell)
				...
				try:
					...
					changeInMetadataValuesTopologySheet = book2.get_sheet_by_name("ChangeInMetadata_Attributes")
					changeInDataValuesSheet = book2.get_sheet_by_name("ChangeInDataValues")
				except:
					message = msg_somethigWrong(None, msg="Please select a valid Excel File")
					message.ShowModal()
					return
				...
				for row_id, row in enumerate(changeInMetadataList_result):
					...
					for col_id, cell in enumerate(row):
						if col_id < 4:
							...
							# changeInMetadataValuesTopologySheet.cell(row=i + 6, column=col_id + 1, value=cell)
						elif col_id == 4:
							if cell == selectedScenarioName1:
								...
								# changeInMetadataValuesTopologySheet.cell(row=i + 6, column=col_id + 1, value=row[5])
								# changeInMetadataValuesTopologySheet.cell(row=i + 6, column=7, value=row[6])
								...
								# changeInMetadataValuesTopologySheet.cell(row=i + 6, column=col_id + 2, value=row[5])
								# changeInMetadataValuesTopologySheet.cell(row=i + 6, column=8, value=row[6])
							...
							if cell == selectedScenarioName1:
								...
								# changeInMetadataValuesTopologySheet.cell(row=i + 6, column=5, value=row[10])
								# changeInMetadataValuesTopologySheet.cell(row=i + 6, column=7, value=row[11])
								...
								# changeInMetadataValuesTopologySheet.cell(row=i + 6, column=6, value=row[10])
								# changeInMetadataValuesTopologySheet.cell(row=i + 6, column=8, value=row[11])
					...
					if row.__len__() > 10 and row[5] == row[10]:
						...
						# changeInMetadataValuesTopologySheet.cell(row=i + 6, column=9, value=row[10])
						# changeInMetadataValuesTopologySheet.cell(row=i + 6, column=5, value="")
						# changeInMetadataValuesTopologySheet.cell(row=i + 6, column=6, value="")
					...
					if row.__len__() > 10 and row[6] == row[11]:
						...
						# changeInMetadataValuesTopologySheet.cell(row=i + 6, column=10, value=row[11])
						# changeInMetadataValuesTopologySheet.cell(row=i + 6, column=7, value="")
						# changeInMetadataValuesTopologySheet.cell(row=i + 6, column=8, value="")
				...
				for row_id, row in enumerate(changeInMetadataAttributeList_result):
					...
					for col_id, cell in enumerate(row):
						if col_id < 4:
							...
							if cell == selectedScenarioName1:
								changeInMetadataValuesTopologySheet.cell(row=i + 6, column=5, value=row[6])
								changeInMetadataValuesTopologySheet.cell(row=i + 6, column=7, value=row[7])
								if not row[6] is None and row[6] != '': count_first_source_attr += 1
								if not row[7] is None and row[7] != '': count_first_method_attr += 1
							else:
								changeInMetadataValuesTopologySheet.cell(row=i + 6, column=6, value=row[6])
								changeInMetadataValuesTopologySheet.cell(row=i + 6, column=8, value=row[7])
							...
							if cell == selectedScenarioName1:
								# changeInMetadataToTopologySheet.cell(row=i + 6, column=5, value=row[10])
								# changeInMetadataToTopologySheet.cell(row=i + 6, column=7, value=row[11])
								changeInMetadataValuesTopologySheet.cell(row=i + 6, column=5, value=row[11])
								changeInMetadataValuesTopologySheet.cell(row=i + 6, column=7, value=row[12])
								...
								changeInMetadataValuesTopologySheet.cell(row=i + 6, column=6, value=row[11])
								changeInMetadataValuesTopologySheet.cell(row=i + 6, column=8, value=row[12])
					...
					if row.__len__() > 10 and row[6] == row[11]:
						...
						changeInMetadataValuesTopologySheet.cell(row=i + 6, column=9, value=row[11])
						changeInMetadataValuesTopologySheet.cell(row=i + 6, column=5, value="")
						changeInMetadataValuesTopologySheet.cell(row=i + 6, column=6, value="")
					...
					if row.__len__() > 10 and row[7] == row[12]:
						...
						changeInMetadataValuesTopologySheet.cell(row=i + 6, column=10, value=row[12])
						changeInMetadataValuesTopologySheet.cell(row=i + 6, column=7, value="")
						changeInMetadataValuesTopologySheet.cell(row=i + 6, column=8, value="")
				...
				for row_id, row in enumerate(list_changInValue):
					for col_id, cell in enumerate(row):
						changeInDataValuesSheet.cell(row=row_id + 6, column=col_id+1, value=cell)


				changeInDataValuesSheet.cell(row=2, column=6, value=selectedScenarioName1)
				changeInDataValuesSheet.cell(row=2, column=7, value=selectedScenarioName2)
				allValueCount = self.compareScenarios.AllDataValuesMapperCount(selectedDataset, selectedMasterNetworkName)
				changeInDataValuesSheet.cell(row=2, column=6, value=first_scenario_value_count)
				changeInDataValuesSheet.cell(row=3, column=6, value=str(round(float(first_scenario_value_count)*100.0/ float(allValueCount) , 2)) + '%')
				changeInDataValuesSheet.cell(row=2, column=7, value=second_scenario_value_count)
				changeInDataValuesSheet.cell(row=3, column=7, value=str(round(float(second_scenario_value_count)*100/ float(allValueCount), 2)) + '%')
				common_count = allValueCount - first_scenario_value_count - second_scenario_value_count
				changeInDataValuesSheet.cell(row=2, column=8, value=common_count)
				changeInDataValuesSheet.cell(row=3, column=8, value=str(round(float(common_count) * 100/ float(allValueCount), 2)) + '%')
				changeInDataValuesSheet.cell(row=2, column=9, value=allValueCount)
				changeInDataValuesSheet.cell(row=3, column=9, value='100%')
				...
				changeInMetadataValuesTopologySheet.cell(row=4, column=5, value=selectedScenarioName1)
				changeInMetadataValuesTopologySheet.cell(row=4, column=6, value=selectedScenarioName2)
				changeInMetadataValuesTopologySheet.cell(row=4, column=7, value=selectedScenarioName1)
				changeInMetadataValuesTopologySheet.cell(row=4, column=8, value=selectedScenarioName2)
				...
				changeInMetadataValuesTopologySheet.cell(row=2, column=5, value=count_first_source_attr)
				changeInMetadataValuesTopologySheet.cell(row=3, column=5, value=str(round(
					float(count_first_source_attr) * 100/ float(allAttrVauleCount - count_common_source_attr), 2)) + '%')
				changeInMetadataValuesTopologySheet.cell(row=2, column=6, value=count_second_source_attr)
				changeInMetadataValuesTopologySheet.cell(row=3, column=6, value=str(round(
					float(count_second_source_attr) * 100/ float(allAttrVauleCount - count_common_source_attr), 2)) + '%')
				changeInMetadataValuesTopologySheet.cell(row=2, column=7, value=count_first_method_attr)
				changeInMetadataValuesTopologySheet.cell(row=3, column=7, value=str(round(
					float(count_first_method_attr) * 100/ float(allAttrVauleCount - count_common_method_attr), 2)) + '%')
				changeInMetadataValuesTopologySheet.cell(row=2, column=8, value=count_second_method_attr)
				changeInMetadataValuesTopologySheet.cell(row=3, column=8, value=str(round(
				...
				changeInMetadataValuesTopologySheet.cell(row=2, column=9, value=count_common_source)
				changeInMetadataValuesTopologySheet.cell(row=3, column=9, value=str(round(
				...
				changeInMetadataValuesTopologySheet.cell(row=2, column=10, value=count_common_method)
				changeInMetadataValuesTopologySheet.cell(row=3, column=10, value=str(round(
					float(rest_method_attr) * 100/ float(allAttrVauleCount), 2)) + '%')
				changeInMetadataValuesTopologySheet.cell(row=2, column=11, value=allAttrVauleCount)
				changeInMetadataValuesTopologySheet.cell(row=3, column=11, value='100%')
