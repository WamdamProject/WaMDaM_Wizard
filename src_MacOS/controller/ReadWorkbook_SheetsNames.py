...
vocab = OrderedDict({
    ...
    "dualvaluemeaning": CV_DualValueMeaning,
...
struct_sheets_ordered = ['ObjectCategory', 'AttributeCategory', '2.1_Datasets&ObjectTypes',
                         '2.2_Attributes']
...
datavalues_sheets_ordered = ['4_NumericValues', '4_SeasonalNumericValues', '4_TimeSeries',
                             '4_DescriptorValues', '4_TimeSeriesValues', '4_DualValues', '4_ElectronicFiles', '4_MultiAttributeSeries']
