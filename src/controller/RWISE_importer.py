...
class RWISE_importer():
    ...
    def load_data(self, xml_string):
        ...
        resource_type = "Reclamation's Water Information System (RWIS)"
        ...
        if exsting is None:
            ...
            resourceTypes.ResourceTypeAcronym = "RWISE"
        ...
        if exsting is None:
            ...
            try:
                ...
                dummy_map, attrib = LoadingUtils.load_mapping([dummy_id, instance_id, source_name,
                                                               method_name, dummy_dataval.ValuesMapperID],
                                                              self.__session)
        ...
        for field in tree.iter('{}parameter'.format(namespace['wml2'])):
            ...
            dataValuesMapper = SqlAlchemy.ValuesMapper()
            try:
                dataValuesMapper.ValuesMapperID = int(self.__session.query(SqlAlchemy.ValuesMapper).order_by(
                    SqlAlchemy.ValuesMapper.ValuesMapperID.desc()).first().ValuesMapperID)
                dataValuesMapper.ValuesMapperID += 1
            except:
                dataValuesMapper.ValuesMapperID = 1
            ...
            dataval_map.ValuesMapperID = dataValuesMapper.ValuesMapperID
            ...
            if datavalues:
                ...
                scenariomap.MappingID = self.__session.query(SqlAlchemy.Mappings).filter(
                    and_(
                        ...
                        SqlAlchemy.Mappings.SourceID == source_id,
                        SqlAlchemy.Mappings.MethodID == method_id,
                        SqlAlchemy.Mappings.ValuesMapperID == dataValuesMapper.ValuesMapperID
                    )
                ).first().MappingID
            ...
            timeSeries.ValuesMapperID = dataValuesMapper.ValuesMapperID
        ...
        for field in tree.iter('{}MeasurementTimeseries'.format(namespace['wml2'])):
            ...
            for point in field.iter('{}MeasurementTVP'.format(namespace['wml2'])):
                ...
                if value is not None or value != '':
                    ...
                    timeSeriesValues.DataValue = value
