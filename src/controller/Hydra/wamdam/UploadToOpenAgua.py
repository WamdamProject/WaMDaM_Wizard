...
from controller.WEAP_exporter.GetDataStructureFromWeap import GetDataStructureFromWeap
from controller.WEAP_exporter.GetInstancesFromWeap import GetInstancesFromWeap
from controller.WEAP_exporter.GetValuesAllFromWeap import GetValuesAllFromWeap
...
for area in WEAP.Areas:
    ...
    WEAP.ActiveArea = area.name

    getDataStructureFromWeap = GetDataStructureFromWeap(WEAP)
    getInstancesFromWeap = GetInstancesFromWeap(WEAP)
    getValuesAllFromWeap = GetValuesAllFromWeap(WEAP)
    ...
    login_response = conn.login('amabdallah@aggiemail.usu.edu', 'xxxxxxxxxx!')
    ...
    type_sheet_resourceTypes = [[default_mode]]
    type_sheet_objectTypes = []

    # Import the attributes
    # attr_sheet = wamdam_data['2.2_Attributes']
    attr_sheet = getDataStructureFromWeap.getAttributes()
    ...
    name_list = []
    network_sheet = []
    # name_list, network_sheet = getInstancesFromWeap.getMasterNetwork(default_mode)
    default_network_name = ''
    ...
    nodes_sheet = getInstancesFromWeap.getNodes()
    ...
    links_sheet = getInstancesFromWeap.getLinkes()
    ...
    for i in range(len(scenario_sheet)):
        ...
        # **************************************************
        # 5.2 Numeric Values
        numerical_sheet = getValuesAllFromWeap.getNumericValue()
    ...
    # Iterate over the rows in the 4_FreeText sheet and associate the value with its scenario, and resource attribute
        Descriptor_sheet = getValuesAllFromWeap.getFreeText()
    ...
    # http://umwrg.github.io/HydraPlatform/devdocs/techdocs/timeseries.html?highlight=seasonal#normal-time-series-and-seasonal-time-series
        ...
        SeasonalNumericValues_sheet = getValuesAllFromWeap.getSeasonaNumericValues()
    ...
    # http://umwrg.github.io/HydraPlatform/devdocs/techdocs/timeseries.html#an-example-in-python
        ...
        TimeSeriesValues_sheet = getValuesAllFromWeap.gettTimeSeriesValues()
    ...
    multiAttr_sheet_up, multiAttr_sheet_bottom = getValuesAllFromWeap.getMultiAttributeSeries()
