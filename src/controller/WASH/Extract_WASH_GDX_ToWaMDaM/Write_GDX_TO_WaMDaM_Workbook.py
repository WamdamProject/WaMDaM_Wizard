        ...
        if symbol_name in ['Qmax','Qmin','aw','instreamReq','lss','Qsim','dReqBase','evap','reachGain']:
            for i, itmes in df.iterrows():
                ...
                if len(itmes) == 3:
                    ...
                    # add controlled vocabulary to each season shortcut name used in WASH
                    if itmes[1] == 't10':
                        Seasonal['SeasonNameCV']='October'
                    elif itmes[1] == 't11':
                        Seasonal['SeasonNameCV'] = 'November'
                    elif itmes[1] == 't12':
                        Seasonal['SeasonNameCV'] = 'December'
                    elif itmes[1] == 't1':
                        Seasonal['SeasonNameCV'] = 'January'
                    elif itmes[1] == 't2':
                        Seasonal['SeasonNameCV'] = 'February'
                    elif itmes[1] == 't3':
                        Seasonal['SeasonNameCV'] = 'March'
                    elif itmes[1] == 't4':
                        Seasonal['SeasonNameCV'] = 'April'
                    elif itmes[1] == 't5':
                        Seasonal['SeasonNameCV'] = 'May'
                    elif itmes[1] == 't6':
                        Seasonal['SeasonNameCV'] = 'June'
                    elif itmes[1] == 't7':
                        Seasonal['SeasonNameCV'] = 'July'
                    elif itmes[1] == 't8':
                        Seasonal['SeasonNameCV'] = 'August'
                    elif itmes[1] == 't9':
                        Seasonal['SeasonNameCV'] = 'September'
