        ...
        try:
            for ida, attrib in enumerate(attributes):
                ...
                if attrib == 'DualValues':
                    ...
                    max_row[1] = self.write_data('4_DualValues', book2, ida, attrib_code, sources, methods, left_data, right_data, max_row[1] + 1)
                    ...
                    max_row[3] = self.write_data('4_DescriptorValues', book2, ida, attrib_code, sources, methods, left_data, right_data, max_row[3] + 1)
