...
class dlg_ServeToWEAP(wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=1, title=u"Serve Data to WEAP", pos=wx.DefaultPosition,
                           size=wx.Size(602, 632), style=wx.DEFAULT_DIALOG_STYLE)

        self.SetSizeHintsSz(wx.DefaultSize, wx.DefaultSize)

        bSizer2 = wx.BoxSizer(wx.VERTICAL)

        self.m_staticText2 = wx.StaticText(self, wx.ID_ANY, u"Select the source of data from WaMDaM to serve into WEAP",
        ...
        self.m_staticText33 = wx.StaticText(self, wx.ID_ANY, u"Select a WEAP model in WaMDaM database",
                                            wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText33.Wrap(-1)
        bSizer2.Add(self.m_staticText33, 0, wx.ALL, 5)

        Select_ModelChoices = []
        self.Select_Model = wx.ComboBox(self, 323, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                        Select_ModelChoices, 0)
        bSizer2.Add(self.Select_Model, 0, wx.ALL | wx.EXPAND, 5)

        self.m_staticText31 = wx.StaticText(self, wx.ID_ANY, u"Select a WEAP network in WaMDaM database",
                                            wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        bSizer2.Add(self.SelectWaMDAM_Network, 0, wx.ALL | wx.EXPAND, 5)

        self.m_staticText32 = wx.StaticText(self, wx.ID_ANY, u"Select a scenario n WaMDaM", wx.DefaultPosition,
                                            wx.DefaultSize, 0)
        ...
        bSizer2.Add(self.Seclect_WaMDaM_Scenrio, 0, wx.ALL | wx.EXPAND, 5)

        self.m_staticline6 = wx.StaticLine(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL)
        bSizer2.Add(self.m_staticline6, 0, wx.EXPAND | wx.ALL, 5)

        self.m_staticText34 = wx.StaticText(self, wx.ID_ANY,
                                            u"Select the destination to the WEAP model to serve WaMDaM data into it",
                                            wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText34.Wrap(-1)
        self.m_staticText34.SetFont(
            wx.Font(9, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "Arial"))

        bSizer2.Add(self.m_staticText34, 0, wx.ALL, 5)

        self.m_staticText30 = wx.StaticText(self, wx.ID_ANY,
                                            u"Choose a WEAP Area (You need  have WEAP installed on your local machine with a licence)",
                                            wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        gSizer11.Add(self.Value_NewWEAPScenario, 1, wx.ALL | wx.EXPAND, 5)

        bSizer2.Add(gSizer11, 1, wx.EXPAND, 5)

        bSizer11 = wx.BoxSizer(wx.VERTICAL)

        # self.m_staticText40 = wx.StaticText(self, wx.ID_ANY,
        #                                     u"Select a location where you want to export the Metadata file ",
        #                                     wx.DefaultPosition, wx.DefaultSize, 0)
        # self.m_staticText40.Wrap(-1)
        # bSizer11.Add(self.m_staticText40, 0, wx.ALL, 5)
        #
        # self.m_dirPicker71 = wx.DirPickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a folder", wx.DefaultPosition,
        #                                       wx.DefaultSize, wx.DIRP_DEFAULT_STYLE)
        # bSizer11.Add(self.m_dirPicker71, 0, wx.ALL | wx.EXPAND, 5)

        bSizer2.Add(bSizer11, 1, wx.EXPAND, 5)

        gSizer51 = wx.GridSizer(0, 2, 0, 0)

        self.btn_serve1 = wx.Button(self, 12, u"Serve To WEAP", wx.DefaultPosition, wx.DefaultSize, 0)
        gSizer51.Add(self.btn_serve1, 0, wx.ALL | wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)

        self.btn_cancel1 = wx.Button(self, 13, u"Cancel", wx.DefaultPosition, wx.DefaultSize, 0)
        gSizer51.Add(self.btn_cancel1, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)

        bSizer2.Add(gSizer51, 1, wx.EXPAND, 5)
        ...
        # Connect Events
        self.Select_Model.Bind(wx.EVT_COMBOBOX, self.Select_ModelOnCombobox)
        self.SelectWaMDAM_Network.Bind(wx.EVT_COMBOBOX, self.SelectWaMDAM_NetworkOnCombobox)
        self.Seclect_WaMDaM_Scenrio.Bind(wx.EVT_COMBOBOX, self.Seclect_WaMDaM_ScenrioOnCombobox)
        self.comboBox_SelectArea.Bind(wx.EVT_COMBOBOX, self.comboBox_SelectAreaOnCombobox)
        self.combo_selectWEAPScenario.Bind(wx.EVT_COMBOBOX, self.combo_selectWEAPScenarioOnCombobox)
        # self.m_dirPicker71.Bind(wx.EVT_DIRPICKER_CHANGED, self.m_dirPicker71OnDirChanged)
        self.btn_serve1.Bind(wx.EVT_BUTTON, self.btn_serveOnButtonClick)
        self.btn_cancel1.Bind(wx.EVT_BUTTON, self.btn_cancelOnButtonClick)
    ...
    def combo_selectWEAPScenarioOnCombobox(self, event):
        event.Skip()

    # def m_dirPicker71OnDirChanged(self, event):
    #     event.Skip()
