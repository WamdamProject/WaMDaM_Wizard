...
class dlg_Publish(wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=90, title=u"Publish a WaMDaM SQLite to HydroShare", pos=wx.DefaultPosition,
                           size=wx.Size(740, 700), style=wx.DEFAULT_DIALOG_STYLE)
        ...
        self.m_textCtrl7 = wx.TextCtrl(self, 111, wx.EmptyString, wx.DefaultPosition, wx.Size(200, -1), 0)
        ...
        self.m_textCtrl8 = wx.TextCtrl(self, 11112, wx.EmptyString, wx.DefaultPosition, wx.Size(200, -1),
                                       wx.TE_PASSWORD)
        gSizer5.Add(self.m_textCtrl8, 0, wx.ALL, 5)

        self.btn_login = wx.Button(self, 651, u"Login", wx.DefaultPosition, wx.DefaultSize, 0)
        gSizer5.Add(self.btn_login, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 5)

        self.m_staticText251 = wx.StaticText(self, wx.ID_ANY, u"Please wait. It might take 1-2 min", wx.DefaultPosition,
                                             wx.DefaultSize, 0)
        self.m_staticText251.Wrap(-1)
        gSizer5.Add(self.m_staticText251, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 5)

        self.m_staticline8 = wx.StaticLine(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL)
        gSizer5.Add(self.m_staticline8, 0, wx.EXPAND | wx.ALL, 5)

        self.m_staticline9 = wx.StaticLine(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL)
        gSizer5.Add(self.m_staticline9, 0, wx.EXPAND | wx.ALL, 5)
...
class dlg_VisulaizeWaMDaM(wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=91, title=u"Visualize WaMDaM Networks and data in OpenAgua",
                           pos=wx.DefaultPosition, size=wx.Size(723, 786), style=wx.DEFAULT_DIALOG_STYLE)
        ...
        self.Btn_Login = wx.Button(self, 645, u"Login", wx.DefaultPosition, wx.DefaultSize, 0)
        gSizer5.Add(self.Btn_Login, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL, 5)

        self.m_staticline5 = wx.StaticLine(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL)
        gSizer5.Add(self.m_staticline5, 0, wx.EXPAND | wx.ALL, 5)

        self.m_staticline152 = wx.StaticLine(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL)
        gSizer5.Add(self.m_staticline152, 0, wx.EXPAND | wx.ALL, 5)

        gSizer52 = wx.GridSizer(2, 2, 0, 0)

        gSizer52.SetMinSize(wx.Size(700, 50))
...
class dlg_ImportFromOpenAgua(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        self.m_textCtr_username = wx.TextCtrl(self, 882, wx.EmptyString, wx.DefaultPosition, wx.Size(200, -1), 0)
        ...
        self.m_textCtrl_pass = wx.TextCtrl(self, 883, wx.EmptyString, wx.DefaultPosition, wx.Size(200, -1),
                                           wx.TE_PASSWORD)
        ...
        m_SelectModelChoices = []
        self.m_SelectModel = wx.ComboBox(self, 8884, wx.EmptyString, wx.DefaultPosition, wx.Size(200, -1),
                                         m_SelectModelChoices, 0)
        gSizer5.Add(self.m_SelectModel, 0, wx.ALL, 5)
        ...
        m_SelectNetworkChoices = []
        self.m_SelectNetwork = wx.ComboBox(self, 885, wx.EmptyString, wx.DefaultPosition, wx.Size(200, -1),
                                           m_SelectNetworkChoices, 0)
        gSizer5.Add(self.m_SelectNetwork, 0, wx.ALL, 5)
        ...
        self.m_selectScenario = wx.ComboBox(self, 886, wx.EmptyString, wx.DefaultPosition, wx.Size(200, -1),
        ...
        self.m_dirPicker_export = wx.DirPickerCtrl(self, 901, wx.EmptyString, u"Select a folder", wx.DefaultPosition,
                                                   wx.Size(200, -1), wx.DIRP_DEFAULT_STYLE)
