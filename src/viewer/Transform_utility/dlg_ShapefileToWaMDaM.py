...
import wx
import viewer.WaMDaMWizard, threading
from viewer.Messages_forms.msg_somethigWrong import msg_somethigWrong
from controller.Transform_utility.shapefileExporter import shapefileExporter
...
class dlg_ShapefileToWaMDaM(viewer.WaMDaMWizard.dlg_ShapefileToWaMDaM):
    def __init__( self, parent ):

        viewer.WaMDaMWizard.dlg_ShapefileToWaMDaM.__init__(self, parent)
    ...
    def btn_ConvertShapefileDataOnButtonClick( self, event ):
        ...
        if self.shape_file:
            ...
            # Show a msg to tell the user to wait.
                ...
                self.waiting_dlg.setMessage("Please wait a moment until loading is done.")
            ...
            # instance.Show()
    def load_data(self):
        shp_export = shapefileExporter()
        shp_export.shapefileExporter(self.shape_file)
